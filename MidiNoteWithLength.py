"""
MidiNoteWithLength Class

Details:
    This is the custom MidiNoteWithLength object this library uses.
...
class MidiNoteWithLength(object):
    ...
    def __add__(self, other):
        return MidiNoteWithLength (self.pitch + other.pitch,
